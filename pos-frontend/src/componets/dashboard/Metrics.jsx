  ...
  return (
    <div className="container mx-auto py-2 px-6 md:px-4">
      <div className="flex justify-between items-center">
        <div className="">
          <h2 className="font-semibold text-[#f5f5f5] text-xl">Загальна ефективність</h2>
          <p className="text-[#ababab] text-sm">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero assumenda nobis consectetur, unde
            voluptate saepe.
          </p>
        </div>
      ...
      <div className="flex flex-col justify-between mt-12">
        <div className="">
          <h2 className="font-semibold text-[#f5f5f5] text-xl">Деталі товару</h2>
          <p className="text-[#ababab] text-sm">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero assumenda nobis consectetur, unde
            voluptate saepe.
          </p>
